            ...
            <nav className="mx-auto max-w-7xl rounded-sm md:rounded-full border border-gray-100 bg-white/60 backdrop-blur-sm shadow-md">
                <div className="flex items-center justify-between px-3 md:px-8 py-3">
                    ...
                    <Link
                        ...
                        <div className="w-11 h-11 rounded-full bg-gradient-to-br from-green-500 to-emerald-700 flex items-center justify-center shadow-md">
                            <FileText
                        ...
                        <div>
                            <h1 className="text-lg hidden md:block font-extrabold md:text-xl font-black tracking-tight bg-gradient-to-r from-green-700 to-emerald-500 text-transparent bg-clip-text">
                                Team Task Management
                            </h1>
                            <h1 className="text-lg md:hidden -mb-1 md:text-2xl font-black tracking-tight bg-gradient-to-r from-green-700 to-emerald-500 text-transparent bg-clip-text">
                                TTM
                            </h1>
                    ...
                    <div className="hidden md:flex items-center gap-2">
                        ...
                        {user?._id ? (
                            <Link
                                to="/dashboard"
                                className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-green-500 to-emerald-600 text-white font-semibold shadow-md hover:shadow-lg hover:scale-[1.02] transition-all duration-300"
                            >
