                    ...
                    <div className="flex items-center gap-2 cursor-pointer">
                        <div className="hidden md:block">
                            {user && user.role === "Admin" ? (
                                <div title="Upgrade" className="text-xs md:text-sm flex items-center gap-1 rounded-full border-teal-500 border-b-2 bg-linear-to-br from-teal-600 to-orange-300 py-1.5 px-4 mr-2 text-gray-50 border-2 border-white font-semibold" onClick={() => navigate(`/pricing`)}>
                                    Upgrade
