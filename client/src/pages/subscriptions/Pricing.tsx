        ...
        <section className="relative -mt-15 overflow-hidden bg-gradient-to-br from-teal-50 via-white to-emerald-100 py-30">
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4">
                ...
                <div className="mx-auto mb-16 max-w-3xl text-center">
                    <div className="mb-4 inline-flex items-center gap-2 border-2 border-teal-200 rounded-full bg-teal-100 px-4 py-2 text-sm font-semibold text-teal-700">
                ...
                <div className="grid md:gap-8 gap-12 md:grid-cols-3">
                    {plans.map((plan, index) => (
                        <div
                            key={index}
                            className={`relative rounded-3xl border bg-white p-8 shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl ${plan.popular
                        ...
                        >
                            ...
                            {/* Button */}
                            <Link
                                to={`/${plan.name === "Free" ? "login" : (`payment/${plan.name}`)}`}
                                className={`block w-full rounded-full px-6 py-4 text-center text-sm font-bold transition-all duration-300 ${plan.popular
