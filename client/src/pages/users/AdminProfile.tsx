...
import { Users, CheckSquare, ChevronLeft, ChevronRight } from "lucide-react";
                            ...
                            <table className="w-full text-sm">
                                <thead className="bg-gray-100 text-gray-700">
                                    <tr>
                                        ...
                                        <th className="text-left px-4 py-3 min-w-35">
                                            Actions
                                        </th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    {paginatedUsers.map((user) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3">
                                                <div className="flex items-center gap-2">
                                                    <button className="text-indigo-600 hover:text-indigo-800 cursor-pointer" onClick={()=>{navigate(`/dashboard/users/${user?._id}/view`)}}>
                                                        View Details
                                                    </button>
                                                </div>
                                            </td>
